          ...
          <div className=" flex flex-wrap">
            ...
            <div className=" w-full px-4 mb-12 md:w-1/3">
                ...
                <ul className=" text-slate-300">
                    ...
                    <li>
                        <a href="#" className=" inline-block text-base hover:text-primary mb-3 ">Desain Web</a>
                    </li>
                </ul>
            </div>
            <div className=" w-full px-4 mb-12 md:w-1/3">
                ...
                <ul className=" text-slate-300">
                    ...
                    <li>
                        <a href="#Home" className=" inline-block text-base hover:text-primary mb-3 ">Tentang Saya</a>
                    </li>
                    <li>
                        <a href="#Projek" className=" inline-block text-base hover:text-primary mb-3 ">Portofolio</a>
                    </li>
                    <li>
...
<p className=" font-medium text-sm text-slate-500 text-center">Dibuat:Septian Adi Nugroho|CSS 3</p>
